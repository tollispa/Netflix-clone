...
<div>
    <button onClick={alerted} className="border bg-gray-300 opacity-70 text-black border-grey-300 py-2 px-5">Play</button>
    <button onClick={alerted} className="border  text-white border-gray-300  ml-4 py-2 px-5">Watch Later</button>
